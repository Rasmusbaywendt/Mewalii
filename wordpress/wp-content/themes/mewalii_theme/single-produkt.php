...
?>
    ...
    <main>
        ...
        <section id="bottom_section">
            ...
            <div id="forslaaede_container">
                <img class="forslaa_billede" src="<?php echo get_stylesheet_directory_uri()?>/img/natbind.jpg" alt="natbind">
                <img class="forslaa_billede" src="<?php echo get_stylesheet_directory_uri()?>/img/duet_pakke.jpeg" alt="duet pakke">
                <img class="forslaa_billede" src="<?php echo get_stylesheet_directory_uri()?>/img/trusseindlæg.jpg" alt="trusseindlæg">
                <img class="forslaa_billede" src="<?php echo get_stylesheet_directory_uri()?>/img/tween-pakke.jpeg" alt="tween pakke">
            </div>
        </section>
